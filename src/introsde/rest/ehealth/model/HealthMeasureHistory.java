...
//@NamedQuery(name="HealthMeasureHistory.findAllByPersonId", query="SELECT h FROM HealthMeasureHistory h, Person p, MeasureDefinition m WHERE h.idMeasureDefinition = m.idMeasureDef AND h.idPerson = p.idPerson AND p.idPerson = :idPerson AND m.measureName = :weight")
@XmlRootElement
public class HealthMeasureHistory implements Serializable {
	...
	public static List<HealthMeasureHistory> getAllByPerson(int idPerson, String measureName) {
		EntityManager em = LifeCoachDao.instance.createEntityManager();
	...
	public static List<HealthMeasureHistory> getMeasureHistoryById(int idPerson, String measureName, int mid) {
		EntityManager em = LifeCoachDao.instance.createEntityManager();
    	int idMeasureDefinition = MeasureDefinition.getIdByName(measureName);
    	List<HealthMeasureHistory> list = new ArrayList<HealthMeasureHistory>();
